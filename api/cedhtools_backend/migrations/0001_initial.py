# Generated by Django 4.2.17 on 2025-01-10 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_elo', models.FloatField(blank=True, null=True)),
                ('mode_elo', models.FloatField(blank=True, null=True)),
                ('median_elo', models.FloatField(blank=True, null=True)),
                ('top_elo', models.FloatField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='standings', to='cedhtools_backend.topdeckplayer')),
